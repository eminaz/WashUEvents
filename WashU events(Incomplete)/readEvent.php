...
<textarea cols="40" rows="5" name="storyBody">
<?php echo $text; ?>
</textarea>

<input type="submit" name="edit" value="Submit Edited Text"/>
</form>
...
mysql_select_db('wustl',$sqlserver);
session_start();
$resultnews = mysql_query('select * from News',$sqlserver);
...
<title>Read Page</title></head>
<body>

<form enctype="multipart/form-data" action="commentary.php" method="post">
...
<form enctype="multipart/form-data" action="eventsDisplaySession.php" method="post">
